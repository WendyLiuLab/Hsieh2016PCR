...
cqs = read_csv("raw-data/il10/2016-09-04 il10 -  Quantification Summary_0.csv") %>%
  select(Well, Cq) %>%
  inner_join(annotations())

melts = read_csv("raw-data/il10/2016-09-04 il10 -  Melt Curve Derivative Results_SYBR.csv") %>%
  select(-X1) %>%
