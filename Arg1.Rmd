...
cqs = read_csv("raw-data/arg1/2016-09-04 arg1 -  Quantification Summary_0.csv") %>%
  select(Well, Cq) %>%
  inner_join(annotations())

melts = read_csv("raw-data/arg1/2016-09-04 arg1 -  Melt Curve Derivative Results_SYBR.csv") %>%
  select(-X1) %>%
